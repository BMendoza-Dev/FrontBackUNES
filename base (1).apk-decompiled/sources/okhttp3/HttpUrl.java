...
public final class HttpUrl {
    ...
    public boolean isHttps() {
        return this.scheme.equals(WebViewLocalServer.httpsScheme);
    }
    ...
    public static int defaultPort(String str) {
        ...
        return str.equals(WebViewLocalServer.httpsScheme) ? 443 : -1;
    }
    ...
    public static final class Builder {
        ...
        public Builder scheme(String str) {
            ...
            if (str.equalsIgnoreCase(WebViewLocalServer.httpScheme)) {
                this.scheme = WebViewLocalServer.httpScheme;
            } else if (str.equalsIgnoreCase(WebViewLocalServer.httpsScheme)) {
                this.scheme = WebViewLocalServer.httpsScheme;
            } else {
