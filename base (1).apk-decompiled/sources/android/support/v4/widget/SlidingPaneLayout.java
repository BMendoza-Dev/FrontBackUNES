        ...
        while (true) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                if (layoutParams.width == -2) {
                    i10 = View.MeasureSpec.makeMeasureSpec(paddingLeft - i15, Integer.MIN_VALUE);
                } else if (layoutParams.width == -1) {
                    i10 = View.MeasureSpec.makeMeasureSpec(paddingLeft - i15, 1073741824);
                } else {
                    i10 = View.MeasureSpec.makeMeasureSpec(layoutParams.width, 1073741824);
                }
                if (layoutParams.height == -2) {
                    ...
                    i11 = View.MeasureSpec.makeMeasureSpec(layoutParams.height, 1073741824);
                }
                childAt.measure(i10, i11);
                int measuredWidth = childAt.getMeasuredWidth();
                int measuredHeight = childAt.getMeasuredHeight();
                if (mode2 == Integer.MIN_VALUE && measuredHeight > i12) {
                    i12 = Math.min(measuredHeight, i3);
                }
                i13 -= measuredWidth;
                boolean z3 = i13 < 0;
                ...
                if (childAt2.getVisibility() == i5) {
                    ...
                    if (childAt2.getVisibility() == i5) {
                        ...
                        if (z2 && childAt2 != this.mSlideableView) {
                            if (layoutParams2.width >= 0 || (measuredWidth2 <= i16 && layoutParams2.weight <= 0.0f)) {
                                i6 = i16;
                            } else {
                                if (z5) {
                                ...
                                childAt2.measure(View.MeasureSpec.makeMeasureSpec(i16, i8), i9);
                                i6 = i16;
                            }
                            ...
                            if (z2) {
                                ...
                                i6 = i16;
                                childAt2.measure(View.MeasureSpec.makeMeasureSpec(measuredWidth2 + ((int) ((layoutParams2.weight * Math.max(0, i13)) / f)), 1073741824), i7);
                            }
                        } else {
                            i6 = i16;
                        }
