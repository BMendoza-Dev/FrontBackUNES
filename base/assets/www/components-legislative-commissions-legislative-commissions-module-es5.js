...
var LegislativeCommissionsPageModule = /** @class */ (function () {
    function LegislativeCommissionsPageModule() {
    }
    ...
    return LegislativeCommissionsPageModule;
}());
...
var LegislativeCommissionsPage = /** @class */ (function () {
    function LegislativeCommissionsPage(properties, route) {
        this.properties = properties;
        this.route = route;
    }
    LegislativeCommissionsPage.prototype.ngOnInit = function () {
        this.id = this.route.snapshot.queryParamMap.get('id');
    };
    LegislativeCommissionsPage.ctorParameters = function () { return [
    ...
    return LegislativeCommissionsPage;
}());
...
//# sourceMappingURL=components-legislative-commissions-legislative-commissions-module-es5.js.map